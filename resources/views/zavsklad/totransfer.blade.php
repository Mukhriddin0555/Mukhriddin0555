            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <table>
                        ...
                        <th class="p-2 pr-7"><a href="{{ route('ourTransfers', ['sap_kod', 'asc'])}}">Сап код</a></th>
                        <th class="p-2 pr-7"><a href="{{ route('ourTransfers', ['sapname', 'asc'])}}">Наименование</a></th>
                        <th class="p-2 pr-7"><a href="{{ route('ourTransfers', ['how', 'asc'])}}">шт</a></th>
                        <th class="p-2 pr-7"><a href="{{ route('ourTransfers', ['toskladname', 'asc'])}}">Сервис</a></th>
                        <th class="p-2 pr-7"><a href="{{ route('ourTransfers', ['answer_id', 'asc'])}}">Ваш ответ</a></th>
                        <th class="p-2 pr-7"><a href="{{ route('ourTransfers', ['text', 'asc'])}}">Примечание</a></th>
                        <th class="p-2 pr-7"></th>
